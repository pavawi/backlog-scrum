...
/**
 * @description: {@link RestControllerAdvice} 基础全局异常处理
 * @author: alan
 * @date: 2021/6/3 22:08
 */
@Slf4j
...
public class GlobalDefaultExceptionHandler {
    ...
    private <T extends Throwable> void errorDispose(T e) throws Throwable {
        ...
        HandlerMethod handlerMethod = (HandlerMethod) request.getAttribute("org.springframework.web.servlet" +
                ".HandlerMapping.bestMatchingHandler");

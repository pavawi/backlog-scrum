package com.zhonyang.scrum.backlog.util;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/backlog?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.zhonyang.scrum.backlog.modules");
...
//        strategy.setSuperControllerClass("你自己的父类控制器,没有就不用设置!");
        // 写于父类中的公共字段
        strategy.setSuperEntityColumns("revision");
